function varargout = lineScanChan1Mask(data,params,varargin)
...
roi_temp = getpref('quickshowPrefs','lineScanChan1Mask');
...
data.lineScanChan1Mask = I_traces;
setpref('quickshowPrefs','lineScanChan1Mask',roi_temp)
