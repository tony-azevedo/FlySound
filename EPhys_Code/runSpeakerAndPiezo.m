...
if isempty(D)
    ...
    load(['C:\Tony\Electrophysiology\EPhys_Data\',date,'\',date,...
        '_F',num2str(exp_info.fly_number),'_C',num2str(exp_info.cell_number),'\WCwaveform_',...
...
if strcmp(data(n).protocol,'testRseal')
    ...
    % save data
    save(['C:\Tony\Electrophysiology\EPhys_Data\',data(n).date,'\',...
...
elseif strcmp(data(n).protocol,'takeSweep')
    ...
    if strcmp(data(n).protocol,'testPiezo')
        ...
        if data(n).stimType==2
            load(['C:\Tony\Electrophysiology\EPhys_Codes\PiezoStim'...
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if strcmp(data(n).stimName,'Courtship Song')
            stimtrain = wavread('C:\Tony\Electrophysiology\EPhys_Code\CourtshipSong.wav');
...
set(gcf,'Position',[275    41   560   420]);
