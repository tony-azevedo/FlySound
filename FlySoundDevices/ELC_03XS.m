classdef ELC_03XS < Device
    ...
    methods
        function obj = ELC_03XS(varargin)
            obj = obj@Device(varargin{:});
            obj.deviceName = 'ELC_03XS';
            ...
            for ol = 1:length(outlabels)
                if strcmp(outlabels{ol},'voltage')
                    if sum(strcmp('IClamp',obj.mode))
                        ...
                        % 1 V output * 0.010 = 10 mV
                        scalefactor = 100*obj.params.VClampScaling;
                        out.voltage = out.voltage/scalefactor;  % mV, convert, this is the desired V injected
    ...
    methods (Access = protected)
        ...
        function defineParameters(obj)
            ...
            obj.params.potential_hp_filter = 0;
            obj.params.potential_lp_filter = 0.5E4;
            obj.params.current_hp_filter = 0;
            obj.params.current_lp_filter = 0.5E4;
            obj.params.headstagegain = 1;

            obj.params.VClampScaling = 1;
            obj.params.IClampScaling = 1;
