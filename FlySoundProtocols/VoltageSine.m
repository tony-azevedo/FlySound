...
classdef VoltageSine < FlySoundProtocol
    
    properties (Constant)
        protocolName = 'VoltageSine';
    end
    ...
    methods
        ...
        function obj = VoltageSine(varargin)
        ...
        function varargout = getStimulus(obj,varargin)
            ...
            obj.out.voltage = obj.y .*sin(2*pi*obj.params.freq*obj.x) * obj.params.amp;
            varargout = {obj.out};
        end
