classdef SealAndLeak_Clamp < FlySoundProtocol
    ...
    methods
        ...
        function obj = SealAndLeak_Clamp(varargin)
        ...
        function run(obj,varargin)
            ...
            for repeat = 1:trialdata.repeats
                ...
                current = (current-trialdata.hardcurrentoffset)*trialdata.hardcurrentscale;
    ...
    methods (Access = protected)
        ...
        function createAIAOSessions(obj)
            ...
            obj.aoSession.addAnalogOutputChannel('Dev1',1, 'Voltage'); % Output channel
