...
classdef AcquirePiezoWithEpiFeedback < FlySoundProtocol
    
    properties (Constant)
        protocolName = 'AcquirePiezoWithEpiFeedback';
    end
    
    properties (SetAccess = protected)
        requiredRig = 'ContinuousEpiFBPiezo2TRig_Acquisition';
        analyses = {};
    end
    ...
    methods
        ...
        function obj = AcquirePiezoWithEpiFeedback(varargin)
