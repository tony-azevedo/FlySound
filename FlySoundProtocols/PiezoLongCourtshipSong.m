...
classdef PiezoLongCourtshipSong < PiezoProtocol

    properties (Constant)
        protocolName = 'PiezoLongCourtshipSong';
    end
    ...
    methods
        ...
        function obj = PiezoLongCourtshipSong(varargin)
    ...
    methods (Access = protected)
        ...
        function setupStimulus(obj,varargin)
            ...
            if ~isempty(stimfn)
                ...
                [standardstim] = audioread('LongCourtshipSong_Standard.wav');
            else
                [standardstim,obj.params.samprateout] = audioread('LongCourtshipSong_Standard.wav');
                stim = standardstim;
            end
