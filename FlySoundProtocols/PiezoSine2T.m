...
classdef PiezoSine2T < PiezoProtocol
    properties (Constant)
        protocolName = 'PiezoSine2T';
    end
    ...
    methods
        ...
        function obj = PiezoSine2T(varargin)
        ...
        function fn = getCalibratedStimulusFileName(obj)
            fn = ['C:\Users\tony\Code\FlySound\StimulusWaves\',...
                sprintf('%s_%.0fk_freq%.2f',...
                obj.protocolName,...,
                obj.params.samprateout/1000,...
                obj.params.freq)];
        end
