...
classdef CurrentStepForceProbe2T < FlySoundProtocol

    properties (Constant)
        protocolName = 'CurrentStepForceProbe2T';
    end
    
    properties (SetAccess = protected)
        requiredRig = 'ForceProbe2TRig';  %CameraEPhysRig BasicEPhysRig
    ...
    methods
        ...
        function obj = CurrentStepForceProbe2T(varargin)
