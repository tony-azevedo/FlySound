...
classdef CurrentStepWithFlash < FlySoundProtocol

    properties (Constant)
        protocolName = 'CurrentStepWithFlash';
    end
    
    properties (SetAccess = protected)
        requiredRig = 'EPhysRigWithEpi';  %CameraEPhysRig BasicEPhysRig
    ...
    methods
        ...
        function obj = CurrentStepWithFlash(varargin)
