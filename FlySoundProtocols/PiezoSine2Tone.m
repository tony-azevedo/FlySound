...
classdef PiezoSine2Tone < PiezoProtocol
    properties (Constant)
        protocolName = 'PiezoSine2Tone';
    end
    ...
    methods
        ...
        function obj = PiezoSine2Tone(varargin)
        ...
        function varargout = getStimulus(obj,varargin)
            obj.uncorrectedcommand = sin(2*pi*obj.params.freq1*obj.x) + sin(2*pi*obj.params.freq2*obj.x);
    ...
    methods (Access = protected)
        ...
        function defineParameters(obj)
            ...
            obj.params.displacements = 0.05 * [.1 3];
            obj.params.displacement = obj.params.displacements(1);
            
            obj.params.ramptime = 0.04; %sec;
            
            % obj.params.cycles = 10;
            obj.params.freq1s = [0 110 140 170];
            obj.params.freq1 = obj.params.freq1s(1); % Hz
            obj.params.freq2s = [0 190 230 270]; 
            obj.params.freq2 = obj.params.freq2s(1); % Hz

            obj.params.stimDurInSec = 6; % obj.params.cycles/obj.params.freq;
            obj.params.preDurInSec = .4;
            obj.params.postDurInSec = .4;
        ...
        function setupStimulus(obj,varargin)
            ...
            obj.params.displacement = obj.params.displacements(1);
            obj.params.freq1 = obj.params.freq1s(1);
            obj.params.freq2 = obj.params.freq2s(1);
            stimfn = which([obj.getCalibratedStimulusFileName,'.wav']);
            if ~isempty(stimfn)
