...
C.rig.devices.epi.setParams('routineToggle',0,'controlToggle',1,'blueToggle',1) % toggle the Epi
C.rig.devices.epi.setParams('routineToggle',0,'controlToggle',1,'blueToggle',0,'irlaserToggle',1) % toggle the Epi
...
C.rig.setParams('waitForLED', 1,'LEDTimeout',10,'ignoreTrialFailures',true); % use the Epi toggle
