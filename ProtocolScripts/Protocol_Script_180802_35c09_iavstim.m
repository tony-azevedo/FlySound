...
setacqpref('MC700AGUIstatus','IClamp_gain','200');
...
A.protocol.setParams('sampratein',100000,'samprateout',100000,'durSweep',1);
...
%% EpiFlash2T % Pulse over 4 orders of magnitude
