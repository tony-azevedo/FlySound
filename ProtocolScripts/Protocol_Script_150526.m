...
A.protocol.setParams('-q','durSweep',0.1,'holdingPotential',10); A.tag('10'); A.run(1)
A.protocol.setParams('-q','durSweep',5); A.run(2);
A.clearTags

A.protocol.setParams('-q','durSweep',0.1,'holdingPotential',20); A.tag('20'); A.run(1)
A.protocol.setParams('-q','durSweep',5); A.run(2);
A.clearTags

A.protocol.setParams('-q','durSweep',0.1,'holdingPotential',30); A.tag('30'); A.run(1)
A.protocol.setParams('-q','durSweep',5); A.run(2);
A.clearTags
...
A.protocol.setParams('-q','durSweep',0.1,'holdingPotential',-40); A.tag('-40'); A.run(1)
A.protocol.setParams('-q','durSweep',5); A.run(2);
A.clearTags

A.protocol.setParams('-q','durSweep',0.1,'holdingPotential',-50); A.tag('-50'); A.run(1)
A.protocol.setParams('-q','durSweep',5); A.run(2);
A.clearTags
