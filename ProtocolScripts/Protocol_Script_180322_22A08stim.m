...
A.rig.setParams('sampratein',10000); A.rig.setParams('samprateout',10000);A.rig.setDefaults;
A.protocol.setParams('-q','sampratein',10000,'samprateout',10000); A.protocol.setDefaults;
