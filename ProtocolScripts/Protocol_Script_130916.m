...
A.protocol.setParams('Vm_id',-1,'freqs',[25,50,100,200,400],'displacements',[0.1 0.2 0.4],'postDurInSec',1.5);
A.run(2)
beep
...
A.protocol.setParams('freqs',[100],'displacements',[0.5 ],'postDurInSec',1.5,'stimDurInSec',0.2,'ramptime',0.02);
A.run(10)
beep
...
%% Hyperpolarize (spikes) (5x5 sec)
A.comment('Curare Hyperpolarize')
A.protocol.setParams('Vm_id',-3);
A.run(5)
beep 

%% Middle range (5x5 sec)
A.comment('Curare Middle')
A.protocol.setParams('Vm_id',-2);
A.run(5)
beep 
...
A.setProtocol('PiezoSine');
A.comment('TTX rest')
A.protocol.setParams('freqs',[25,50,100,200,400],'displacements',[0.4],'postDurInSec',1.5);
A.run(3)
beep
